...
<head>
    ...
    <title>Teacher Registration - LMS TALINO</title>
    ...
    <div class="registration-container">
        <div class="registration-card">
            <div class="card-header">
                ...
                <h3 class="mb-0">Teacher Registration</h3>
                <p class="mb-0 mt-2 opacity-75">Create and manage courses</p>
            </div>
            ...
            <div class="card-body p-4">
                ...
                <form action="<?= base_url('/register/teacher') ?>" method="post">
                    <?= csrf_field() ?>
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" id="department" name="department" required>
                            ...
                            <option value="Business" <?= old('department', $old_input['department'] ?? '') === 'Business' ? 'selected' : '' ?>>Business</option>
                            <option value="Mathematics" <?= old('department', $old_input['department'] ?? '') === 'Mathematics' ? 'selected' : '' ?>>Mathematics</option>
                            <option value="Science" <?= old('department', $old_input['department'] ?? '') === 'Science' ? 'selected' : '' ?>>Science</option>
                        </select>
                    </div>

                    <div class="mb-3">
                        <label for="specialization" class="form-label">
                            <i class="fas fa-graduation-cap me-1"></i>Specialization
                        </label>
                        <input type="text" class="form-control" id="specialization" name="specialization" 
                               value="<?= old('specialization', $old_input['specialization'] ?? '') ?>" 
                               placeholder="e.g., Web Development, Database Systems" required>
                    </div>
                ...
                <div class="text-center mt-4">
                    <p class="mb-0">Already have an account? 
                        <a href="<?= base_url('/login') ?>" class="text-success text-decoration-none fw-bold">Login here</a>
                    </p>
                    <p class="mb-0 mt-2">
